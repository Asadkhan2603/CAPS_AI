...
async def upload_submission(
    ...
    document = {
        ...
        'ocr_result_state': parsed_file.extraction_diagnostics.get('ocr_result_state'),
        'ocr_retry_count': parsed_file.extraction_diagnostics.get('ocr_retry_count'),
        'ocr_timeout_seconds': parsed_file.extraction_diagnostics.get('ocr_timeout_seconds'),
        'ocr_error': parsed_file.extraction_diagnostics.get('ocr_error'),
        'ocr_retry_guidance': parsed_file.extraction_diagnostics.get('ocr_retry_guidance'),
