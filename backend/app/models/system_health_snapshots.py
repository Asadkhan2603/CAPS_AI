...
def system_health_snapshot_public(document: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "club_requests_15m": int(document.get("club_requests_15m") or 0),
        "club_slow_requests_15m": int(document.get("club_slow_requests_15m") or 0),
        "club_server_errors_15m": int(document.get("club_server_errors_15m") or 0),
        "club_p95_duration_ms_15m": document.get("club_p95_duration_ms_15m"),
