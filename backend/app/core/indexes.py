...
async def ensure_indexes() -> None:
    ...
    await _safe_create_index(db.semester_results, [('student_user_id', ASCENDING), ('semester_id', ASCENDING), ('is_active', ASCENDING)])
    await _safe_create_index(db.semester_results, [('status', ASCENDING), ('released_at', ASCENDING)])
    await _safe_create_index(db.exams, [('section_id', ASCENDING), ('semester_id', ASCENDING), ('scheduled_for', ASCENDING), ('is_active', ASCENDING)])
    await _safe_create_index(db.exams, [('teacher_user_id', ASCENDING), ('status', ASCENDING), ('scheduled_for', ASCENDING)])
    ...
    await _safe_create_index(db.students, [('user_id', ASCENDING)], unique=True, partialFilterExpression={'is_active': True, 'user_id': {'$exists': True}})
