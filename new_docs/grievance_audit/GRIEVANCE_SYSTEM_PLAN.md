...
- Add frontend pages:
  - student grievance page with banner-triggered create modal, list, detail timeline, public thread
...
- Student can open the grievance compose modal from the `CREATE` shortcut and submit successfully.
