...
Status: `In Progress`
1. Introduce migration/version strategy for Mongo data shapes. (in progress: submissions and evaluations now persist `schema_version`, and dry-run/apply backfill scripts exist)
